...
const PIPELINE_STEPS = [
    {
        id: 'vision',
        label: 'READING',
        subLabel: 'Reading your syllabus',
        tool: 'Syllabus Input',
        icon: Eye,
        color: 'text-blue-500',
        bg: 'bg-blue-500/10',
    ...
    },
    {
        id: 'search',
        label: 'PAPERS',
        subLabel: 'Analyzing previous papers',
        tool: 'Question Bank',
        icon: Globe,
    ...
    },
    {
        id: 'fusion',
        label: 'PATTERNS',
        subLabel: 'Finding repeated questions',
        tool: 'Frequency Logic',
        icon: Database,
    ...
    },
    {
        id: 'brain',
        label: 'ANSWERS',
        subLabel: 'Generating exam-focused answers',
        tool: 'Gemini Flash',
        icon: Brain,
        color: 'text-rose-500',
        bg: 'bg-rose-500/10',
    ...
    },
    {
        id: 'presentation',
        label: 'READY',
        subLabel: 'Preparing important questions',
        tool: 'React Cards',
        icon: Layout,
